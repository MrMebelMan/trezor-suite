...
describe('data/ConnectSettings', () => {
    it('corsValidator', () => {
        ...
        expect(
             corsValidator('https://multiple.sub.domain.trezor.io/'),
        ).toBeDefined();
        ...
        expect(
             corsValidator('https://non!alpha*numeric?.trezor.io/'),
        ).not.toBeDefined();
        ...
        expect(
             corsValidator('https://multiple.sub.domain.sldev.cz/'),
        ).toBeDefined();
        ...
        expect(
             corsValidator('https://non!alpha*numeric?.sldev.cz/'),
        ).not.toBeDefined();
        ...
        expect(
             corsValidator('https://other-domain.com/connect.trezor.io/8/'),
        ).not.toBeDefined();
    });
