...
const DEFINITION_PATCH = {
    TxInputType: fs.readFileSync('./protobuf-patches/TxInputType.js', 'utf8'),
    TxOutputType: fs.readFileSync('./protobuf-patches/TxOutputType.js', 'utf8'),
    TxAck: fs.readFileSync('./protobuf-patches/TxAck.js', 'utf8'),
};
